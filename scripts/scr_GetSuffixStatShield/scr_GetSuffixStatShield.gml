...
Syntax:
scr_GetPrefixStatShield(itemLevel);

itemLevel	The item's level

This script gets an appropriate suffix for shield slot items.
...
if (iLvl >= 10){
	...
	switch chance{
		...
		case 5:	choice = stat.hitRecovery;	break;
		case 6:	choice = stat.poisonLength;	break;
		case 7: choice = stat.coldLength;	break;
	}
}
// ITEM LEVEL 15+ ROLLS
if (iLvl >= 15){
	...
	switch chance{
		...
		case 6:	choice = stat.poisonLength;	break;
		case 7: choice = stat.coldLength;	break;
		case 8: choice = stat.requirements;	break;
	}
}
// ITEM LEVEL 40+ ROLLS
if (iLvl >= 40){
	...
	switch chance{
		...
		case 7: choice = stat.coldLength;	break;
		case 8: choice = stat.requirements;	break;
		case 9: choice = stat.healthRegen;	break;
		case 10: choice = stat.manaRegen;	break;
	}
}
