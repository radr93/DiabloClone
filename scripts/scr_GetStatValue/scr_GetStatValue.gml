...
switch _stat{
	...
	case stat.castRate:
		// Necks Only
		if (_type == type.jewelry and _subType == jewelry.neck){
			if(iLvl <= 34) { choice = 10; }
			else if(iLvl >= 35) { return(20); }
		}
		// Rings Only
		else if (_type == type.jewelry and _subType == jewelry.ring){
	...
	case stat.allResist:
		...
		// Neck
		else if (_type == type.jewelry and _subType == jewelry.neck){
