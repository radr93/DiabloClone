...
if (keyboard_check_pressed(input.toggleMessageBox) and obj_UIController.showSaveMenu == false and input.free){
...
if (keyboard_check_pressed(input.enter)){
	...
	else if (instance_exists(obj_Console)){ // Otherwise, the console is open
